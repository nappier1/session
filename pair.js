...
╔═════◇
║ 『••• 𝗩𝗶𝘀𝗶𝘁 𝗙𝗼𝗿 𝗛𝗲𝗹𝗽 •••』
║❒ 𝐓𝐮𝐭𝐨𝐫𝐢𝐚𝐥: _youtube.com/@comingsoon
║❒ 𝐎𝐰𝐧𝐞𝐫: _https://wa.me/254116141363
║❒ 𝐑𝐞𝐩𝐨: _https://github.com/Nappier1
║❒ 𝐖𝐚𝐂𝐡𝐚𝐧𝐧𝐞𝐥: _https://whatsapp.com/channel/0029VbBRLb04dTnRzJI0781D_
║ 💜💜💜
╚══════════════╝ 
...
`;
                        ...
                        try {
                            const giftedMess = {
                                image: { url: 'https://files.catbox.moe/ehk185.png' },
                                caption: NAPPIER_TEXT,
                                contextInfo: {
                            ...
                            const giftedAud = {
                                audio: { url: 'https://files.catbox.moe/sid63m.mp3' },
                                mimetype: 'audio/mpeg',
                                ptt: true,
                                contextInfo: {
                                    mentionedJid: [Gifted.user.id],
            ...
            if (!responseSent && !res.headersSent) {
                res.status(500).json({ code: "Service is Currently fucking kathara" });
                responseSent = true;
            }
            await cleanUpSession();
        }
